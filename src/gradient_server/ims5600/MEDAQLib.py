...
class MEDAQLib:
    ...
    if os.name == 'nt':
        ...
        medaq_lib = WinDLL((str(parent_path / "MEDAQLib.dll")))
        medaq_lib_cdecl = CDLL((str(parent_path / "MEDAQLib.dll")))
    else:
    ...
    def OpenSensorIF2008_ETH(self, remoteAddr, channelNumber):
        """Set the parameters for IF2008 ETH interface before calling OpenSensor
         :param remoteAddr: IP Address of the IF2008/ETH server
         :param channelNumber: Channel Number on IF2008/ETH Interface
         :return: none
        """
        self._last_error = self._open_sensor_if2008_eth_org(self.iSensor, bytes(remoteAddr, "utf8"), channelNumber)
    ...
    def init_sensor_functions(self):
        ...
        self._open_sensor_if2008_eth_org = MEDAQLib.medaq_lib.OpenSensorIF2008_ETH
        self._open_sensor_if2008_org.argtypes = [c_uint32, c_char_p, c_int32]
